                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('productUpdate', $product->id) }}" method="post"
                                        ...
                                        <select name="category" id=""
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if (old('category', $product->category_id) == $category->id) selected @endif>{{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                    ...
                                    <div class="form-group">
                                        <img src="{{ Storage::url('image/' . $product->image) }}" alt=""
                                            class="my-2"> <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="waiting_time" name="waiting_time"
                                            value="{{ old('waiting_time', $product->waiting_time) }}" type="text"
