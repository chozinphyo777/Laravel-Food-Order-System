...
@section('content')
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5 m-2">
            <a href="{{ route('fontendHomePage') }}" class="text-muted text-decoration-none"><i
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ Storage::url('image/' . $product->image) }}" alt="Image">
                        </div>
                    ...
                    @foreach ($products as $item)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ Storage::url('image/' . $item->image) }}"
                                    alt="">
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square"
                                        href="{{ route('frontendProductDetail', $item->id) }}"><i
